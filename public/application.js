...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.signIn(data).then(ui.signInSuccess).catch(ui.signInFailure).then(api.getAllGames).then(ui.loadGamesSuccess).catch(ui.loadGamesFailure);
	};

	var showDeleteConfirm = function showDeleteConfirm(event) {
	  $('#deleteGameConfirm').modal('show');
	  $('#delete-game-id').val($(event.target).data('id'));
	};

	var hideDeleteGameConfirm = function hideDeleteGameConfirm() {
	  $('#deleteGameConfirm').modal('hide');
	};

	var showNewPlaythroughForm = function showNewPlaythroughForm(event) {
	  hideNewPlaythroughForm();
	  var gameID = $(event.target).data('id');
	  var matchesGame = function matchesGame() {
	...
	var hideNewPlaythroughForm = function hideNewPlaythroughForm() {
	...
	var openEditGameModal = function openEditGameModal(event) {
	  $('#updateGameModal').modal('show');
	  fillGameValues(event);
	};

	var fillGameValues = function fillGameValues(event) {
	...
	var onShowGame = function onShowGame(event) {
	  event.preventDefault();
	  api.getGame().then(ui.loadGameSuccess).catch(ui.loadGameFailure);
	};

	var onShowPlaythroughs = function onShowPlaythroughs(event) {
	  document.getElementsByClassName('playthrough-content')[0].id = $(event.target).data('id');
	  event.preventDefault();
	  api.getPlaythroughs().then(ui.showPlaythroughsSuccess).catch(ui.showPlaythroughsFailure);
	};
	...
	var onCreatePlaythrough = function onCreatePlaythrough(event) {
	  event.preventDefault();
	  onShowPlaythroughs(event);
	  var data = getFormFields(this);
	  api.createPlaythrough(data).then(ui.createPlaythroughSuccess).catch(ui.createPlaythroughFailure).then(api.getPlaythroughs).then(ui.showPlaythroughsSuccess).catch(ui.showPlaythroughsFailure);
	};

	var onUpdateGame = function onUpdateGame(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.updateGame(data).then(ui.updateGameSuccess).catch(ui.updateGameFailure).then(api.getAllGames).then(ui.loadGamesSuccess).catch(ui.loadGameFailure);
	};

	var onUpdatePlaythrough = function onUpdatePlaythrough(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.updatePlaythrough(data).then(ui.updatePlaythroughSuccess).catch(ui.updatePlaythroughFailure).then(api.getPlaythroughs).then(ui.showPlaythroughsSuccess).catch(ui.showPlaythroughsFailure);
	};

	var onUpdatePlaythroughPrompt = function onUpdatePlaythroughPrompt(event) {
	...
	var onDeleteGame = function onDeleteGame(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.deleteGame(data).then(ui.deleteGameSuccess).catch(ui.deleteGameFailure).then(api.getAllGames).then(ui.loadGamesSuccess).catch(ui.loadGamesFailure);
	};

	var onDeletePlaythrough = function onDeletePlaythrough(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.deletePlaythrough(data).then(ui.deletePlaythroughSuccess).catch(ui.deletePlaythroughFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createPlaythrough = function createPlaythrough(data) {
	  return $.ajax({
	...
	var getPlaythroughs = function getPlaythroughs(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/playthroughs',
	    method: 'GET',
	    headers: {
	...
	var updatePlaythrough = function updatePlaythrough(data) {
	  return $.ajax({
	...
	var deletePlaythrough = function deletePlaythrough(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/playthroughs/' + data.playthrough.id,
	    method: 'DELETE',
	    headers: {
	...
	module.exports = {
	  ...
	  createPlaythrough: createPlaythrough,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showPlaythroughsTemplate = __webpack_require__(32);
	...
	var createPlaythroughSuccess = function createPlaythroughSuccess(data) {
	  showPlaythroughsSuccess(data);
	};

	var createPlaythroughFailure = function createPlaythroughFailure() {
	...
	var showPlaythroughsSuccess = function showPlaythroughsSuccess(data) {
	  var filteredData = data.playthroughs.filter(function (item) {
	    return item.game_id == document.getElementsByClassName('playthrough-content')[0].id;
	  });
	  var showPlaythroughsHtml = showPlaythroughsTemplate({ playthroughs: filteredData });
	...
	var showPlaythroughsFailure = function showPlaythroughsFailure() {
	...
	var updatePlaythroughSuccess = function updatePlaythroughSuccess(data) {
	  $('#updatePlaythroughModal').modal('hide');
	};

	var updatePlaythroughFailure = function updatePlaythroughFailure() {
	...
	var deletePlaythroughSuccess = function deletePlaythroughSuccess(data) {
	  showPlaythroughsSuccess(data);
	};

	var deletePlaythroughFailure = function deletePlaythroughFailure() {};
	...
	module.exports = {
	  ...
	  createPlaythroughSuccess: createPlaythroughSuccess,
	  createPlaythroughFailure: createPlaythroughFailure,
	  showPlaythroughsSuccess: showPlaythroughsSuccess,
	  showPlaythroughsFailure: showPlaythroughsFailure,
	  updatePlaythroughSuccess: updatePlaythroughSuccess,
	  updatePlaythroughFailure: updatePlaythroughFailure,
	  deletePlaythroughSuccess: deletePlaythroughSuccess,
	  deletePlaythroughFailure: deletePlaythroughFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<tr>\n    <td><p class=\"table-data\">"
	    ...
	    + "</p></td>\n    <td>  "
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.genre : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " </td>\n      <td> <p class=\"table-data\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.platform : stack1), depth0))
	    + "</p> </td>\n        <td>  "
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.release : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " </td>\n          <td>  "
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.developer : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " </td>\n            <td>  "
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.publisher : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " </td>\n              <td>  "
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.playtime : stack1),{"name":"if","hash":{},"fn":container.program(18, data, 0, blockParams),"inverse":container.program(20, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " </td>\n                <td>\n\n                  <form class=\"add-playthrough\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n                    <fieldset>\n                      <input class='pop-up-fields text-field new-playthrough-visible'' type='number' placeholder='Completion %' name='playthrough[completion]'><br> <br>\n                      <input class='pop-up-fields text-field new-playthrough-visible'' type='number' placeholder='Playtime' name='playthrough[time]'><br> <br>\n                      <p><span class=\"star-required\">*</span>&nbsp;&nbsp; Started:</p>\n                      <input class='pop-up-fields text-field' type='date' placeholder='Start Date' name='playthrough[date_started]'><br><br>\n                      <p>Finished:</p>\n                      <input class='pop-up-fields text-field new-playthrough-visible' type='date' placeholder='End Date' name='playthrough[date_finished]'> <br> <br>\n                      <input class='pop-up-fields text-field' type='hidden' value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " name='playthrough[game_id]'>\n                      <input class='pop-up-fields text-field' type='hidden' value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1), depth0))
	    + " name='playthrough[user_id]'>\n                      <button class=\"btn btn-primary btn-lg\" type=\"submit\" name=\"submit\">Submit</button>\n                    </fieldset>\n                  </form>\n\n                  <button class=\"add-playthrough-prompt btn btn-primary btn-lg\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                    <i data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"fa fa-plus-square\" aria-hidden=\"true\"></i>\n                  </button>\n\n                  <form class=\"show-playthroughs\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n                    <fieldset>\n                      <input class='pop-up-fields text-field' type='hidden' value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " name='playthrough[game_id]'>\n                      <button class=\"show-playthroughs update-button btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#playthroughsModal\" type=\"submit\" name=\"submit\"><i class=\"fa fa-eye\" aria-hidden=\"true\"></i></button>\n                    </fieldset>\n                  </form>\n\n                  <button type=\"button\" class=\"close-new-playthrough btn btn-primary btn-lg\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                    <i data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"fa fa-times\" aria-hidden=\"true\"></i>\n                </button>\n\n                </td>\n                  <td>\n\n                    <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"delete-btn btn btn-primary btn-lg\" type=\"submit\"><i data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"fa fa-trash\" aria-hidden=\"true\"></i></button>\n\n                    <button class=\"update-game-button btn btn-primary btn-lg\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-title=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\" data-genre=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.platform : stack1), depth0))
	    + "\" data-release=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.release : stack1), depth0))
	    + "\" data-developer=\""
	    ...
	    + "\" data-playtime=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.playtime : stack1), depth0))
	    + "\" type=\"button\" class=\"update-game-button btn btn-primary btn-lg\">\n                      <i class=\"fa fa-pencil\" aria-hidden=\"true\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-title=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\" data-genre=\""
	  ...
	  return "\n        <p class=\"table-data\">"
	    ...
	    return "        <p class=\"table-data\">No genre</p>\n      ";
	},"6":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n            <p class=\"table-data\">"
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.release : stack1), depth0))
	    + "</p>\n";
	},"8":function(container,depth0,helpers,partials,data) {
	    return "            <p class=\"table-data\">No release</p>\n          ";
	  ...
	  return "\n              <p class=\"table-data\">"
	    ...
	    return "              <p class=\"table-data\">No developer</p>\n            ";
	},"14":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n                <p class=\"table-data\">"
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.publisher : stack1), depth0))
	    + "</p>\n";
	},"16":function(container,depth0,helpers,partials,data) {
	    return "                <p class=\"table-data\">No publisher</p>\n              ";
	},"18":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n                <p class=\"table-data\">"
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.playtime : stack1), depth0))
	    + "</p>\n";
	},"20":function(container,depth0,helpers,partials,data) {
	    return "                  <p class=\"table-data\">0</p>\n                ";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <h2>"
	    ...
	    + "</h2>\n  <form class=\"playthrough-delete\">\n      <fieldset>\n        <input class='pop-up-fields text-field' type='hidden' value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " name='playthrough[id]'>\n        <button class=\"btn btn-primary btn-lg\" type=\"submit\"><i class=\"fa fa-trash\" aria-hidden=\"true\"></i></button\n      </fieldset>\n    </form>\n    <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"playthrough-update-button btn btn-primary btn-lg\" data-completion=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.completion : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-time=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.time : stack1), depth0))
	    + "\" data-start=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_started : stack1), depth0))
	    + "\" data-finish=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_finished : stack1), depth0))
	    + "\">\n      <i class=\"fa fa-pencil\" aria-hidden=\"true\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-completion=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.completion : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_started : stack1), depth0))
	    + "</h3>\n  <div>\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.date_finished : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.time : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.completion : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    <hr>\n\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "      <h3>Completed: "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.date_finished : stack1), depth0))
	    + "</h3>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "      <h3>Unfinished</h3>\n";
	},"6":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
	  ...
	  return "      <h3>"
	    ...
	    return "      <h3>No time data</h3>\n";
	},"10":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "      <h3>"
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.completion : stack1), depth0))
	    + "% complete</h3>\n";
	},"12":function(container,depth0,helpers,partials,data) {
	    return "      <h3>No completion data</h3>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.playthroughs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "4aaa6dbc6b386e5fcc1c74d02e060404.jpg";
